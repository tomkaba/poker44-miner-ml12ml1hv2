...
Minimal release repository for model gen12ml1hv2.
...
```bash
git clone https://github.com/tomkaba/poker44-miner-gen12ml1hv2.git
cd poker44-miner-gen12ml1hv2
python3 -m venv .venv
...
git lfs install
git lfs pull --include weights/ml_realbench_1h_v2_seed123_hgb_deep_model.pkl
```
...
- Artifacts:
  - weights/ml_realbench_1h_v2_seed123_hgb_deep_model.pkl
  - weights/ml_realbench_1h_v2_seed123_hgb_deep_scaler.pkl
